...
== C#BrandJ IF ~GlobalGT("C#Brandock_Possessions","GLOBAL",0) Global("C#Brandock_Shapeshift","GLOBAL",0)~ THEN @13/* ~[Brandock, kaputtes Buch wiedergefunden NO Halboger Incident] You mean the way I mistreat and lose my valuable magic possessions?...~ */
== C#BrandJ IF ~GlobalGT("C#Brandock_Possessions","GLOBAL",0) GlobalGT("C#Brandock_Shapeshift","GLOBAL",2)~ THEN @14 /* ~[Brandock, kaputtes Buch wiedergefunden AND Halboger Incident] You mean the way I mistreat and lose my valuable magic possessions and tamper with wild magic I don't understand?...~ */
== C#BrandJ IF ~Global("C#Brandock_Possessions","GLOBAL",0) 
...
== C#BrandJ @19 /* ~[Brandock] I thank you, Brage. I... I strive to understand what I'm doing *before* becoming too powerful...~ */
EXIT
...
== C#BrandJ @21 /* ~[Brandock] Yes, I can assure you that I do not wish us to repeat what happened to you... I am so sorry, that was rather insensitive of me to say.~ */
...
== C#BrandJ @28 /* ~[Brandock] For implying that I'm still not as experienced as I should be? That's painfully true, I would say.~ */
...
== C#BrandJ @30 /* ~[Brandock] Oh, but... but you are right about my physiology lacking any strength. And my mind - calling me weak is not an insult, it's an understatement...~ */
...
== C#BrandJ @40 /* ~[Brandock] Yes, Imoen - not fair. At all. And you know very well why!...~ */
== ~%IMOEN_BANTER%~ @41 /* ~[Imoen] I'm sorry, Brandock. I know you aren't a woman. Calling you a witch is probably...~ */
== C#BrandJ @42 /* ~[Brandock] What? No! I have absolutely no problem with that. But we will never be like Minsc and Dynaheir. Not because Dynaheir is probably 100 times wiser and more deliberate than me - but because Brage doesn't have a fluffy giant miniature space hamster! And probably never will have one!~ */
